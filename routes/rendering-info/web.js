...
module.exports = {
  ...
  handler: async function (request, h) {
    ...
    const renderingInfo = {
      ...
      scripts: [
        {
          content: 'var p = new Promise(function(resolve) { resolve(); }) p.then(function() { console.log ("Q-isotype script executed")});'
        }
      ],
      markup: `<h1>${item.title}</h1><h2>${item.subtitle}</h2><p>rendered by Q-isotype`
    }
